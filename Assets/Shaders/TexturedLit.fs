...
// Identical lighting model to Lit.fs. GLSL 330 has no #include mechanism,
// so this is duplicated for now; if the duplication becomes a maintenance
// problem, a small shader-source preprocessor in ShaderLoader could stitch
// shared chunks together, but that's out of scope for this pass.
...
void main()
{
    ...
    FragColor = vec4(result * VertexColor * texColor.rgb, texColor.a);
}
