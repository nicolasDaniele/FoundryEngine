...
Mesh MeshFactory::CreateCube(const Vec3& color)
{
	...
	// NOTE: normals below were previously all {0,0,0} - a mesh with null
	// normals renders fully black under any lit shader, since every
	// dot(normal, lightDir) evaluates to 0. Each block of 6 vertices is one
	// face, so it gets a single flat-shaded face normal.
